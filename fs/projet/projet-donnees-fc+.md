[Documentation Fournisseur de Service](../README.md) > [Je gère un projet d'intégration de FranceConnect+](README.md) > Quelles sont les données que je peux récupérer par FranceConnect+ sur mes usagers ?
